    ...
    <body>
        <div class="main">
            <form action="" method="POST" class="form" id="form-1">
                ...
                <p class="desc">Cùng nhau mua sách tại COMPANY NAME</p>
                ...
                <a style="margin-top:12px; font-size:14px;" href="../user/loginuser.php?status=true">Đăng nhập nếu có tài khoản</a>
            </form>
            <div>
                <?php
                    session_start();
                    ...
                    if(isset($_POST['dangky'])) {
                        ...
                        if (!$tenkhachhang || !$taikhoan || !$matkhau || !$rematkhau || !$email || !$dienthoai || !$diachi)
                        {
                            ...
                            $query_dangky=mysqli_query($my_connect,$sql_dangky);
                            if($query_dangky){
